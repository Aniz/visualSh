...
namespace Ufba.vShome
{
	...
	/// </summary>
	internal partial class vShomeExplorer : vShomeExplorerBase
	{
		/// <summary>
		/// Constructs a new vShomeExplorer.
		/// </summary>
		public vShomeExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the vShomeExplorerToolWindow.
	/// </summary>
	internal abstract class vShomeExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new vShomeExplorerBase.
		/// </summary>
		protected vShomeExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.vShomeExplorerMenu;
			}
		}
		...
		{
			get { return global::Ufba.vShome.ModelRoot.DomainClassId; }
		}
