...
namespace Ufba.vShome
{
	...
	/// </summary>
	internal partial class vShomeDocView : vShomeDocViewBase
	{
		/// <summary>
		/// Constructs a new vShomeDocView.
		/// </summary>
		public vShomeDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class vShomeDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new vShomeDocView.
		/// </summary>
		protected vShomeDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			vShomeDocDataBase docData = this.DocData as vShomeDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for vShomeDocViewBase should be an vShomeDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Ufba.vShome.vShomeDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Ufba.vShome.vShomeDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Ufba.vShome.vShomeToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Ufba.vShome.vShomeToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.vShomeDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Ufba.vShome.vShomeHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Ufba.vShome.vShomeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Ufba.vShome.vShomeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
