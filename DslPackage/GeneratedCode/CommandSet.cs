...
namespace Ufba.vShome
{
	...
	/// </summary>
	internal partial class vShomeCommandSet : vShomeCommandSetBase
	{
		/// <summary>
		/// Constructs a new vShomeCommandSet.
		/// </summary>
		public vShomeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class vShomeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new vShomeCommandSetBase.
		/// </summary>
		protected vShomeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		{
			vShomeExplorerToolWindow explorer = this.vShomeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		internal virtual void OnMenuValidateModel(object sender, System.EventArgs e)
		{
			...
			{
				this.CurrentvShomeDocData.ValidationController.Validate(this.CurrentvShomeDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected vShomeDocData CurrentvShomeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as vShomeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected vShomeDocView CurrentvShomeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as vShomeDocView;
			}
		}
		...
		/// </summary>
		protected vShomeExplorerToolWindow vShomeExplorerToolWindow
		{
			get
			{
				vShomeExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(vShomeExplorerToolWindow), true) as vShomeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				vShomeExplorerToolWindow explorerWindow = this.vShomeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class vShomeClipboardCommandSet : vShomeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new vShomeClipboardCommandSet.
		/// </summary>
		public vShomeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class vShomeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new vShomeClipboardCommandSetBase.
		/// </summary>
		protected vShomeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
