...
namespace Ufba.vShome
{
	...
	[VSShell::ProvideToolWindow(typeof(vShomeExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"vShome", typeof(vShomeEditorFactory))]

	internal abstract partial class vShomePackageBase : DslShell::ModelingPackage
	{
		protected global::Ufba.vShome.vShomeToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new vShomeEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Ufba.vShome.vShomeToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			vShomeCommandSet commandSet = new vShomeCommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			vShomeClipboardCommandSet clipboardCommandSet = new vShomeClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(vShomeExplorerToolWindow));
...
namespace Ufba.vShome
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Ufba.vShome.vShomeDirectiveProcessor), global::Ufba.vShome.vShomeDirectiveProcessor.vShomeDirectiveProcessorName, "A directive processor that provides access to vShome files")]
	[global::System.Runtime.InteropServices.Guid(Constants.vShomePackageId)]
	internal sealed partial class vShomePackage : vShomePackageBase
	{
	}
}