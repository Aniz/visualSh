...
namespace Ufba.vShome
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides vShome files
	/// The implementation is done in vShomeDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class vShomeDirectiveProcessor : vShomeDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public vShomeDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides vShome files
	/// </summary>
	public class vShomeDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string vShomeDirectiveProcessorName = "vShomeDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "vShome";
		...
		/// Constructor
		/// </summary>
		public vShomeDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return vShomeDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Ufba.vShome.ModelRoot));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Ufba.vShome.ModelRoot));
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("vShomeDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
