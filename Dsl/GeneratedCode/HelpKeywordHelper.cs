...
namespace Ufba.vShome
{
	...
	/// </remarks>
	public partial class vShomeHelpKeywordHelper : vShomeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new vShomeHelpKeywordHelper.
		/// </summary>
		protected vShomeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the vShomeHelpKeywordHelper.
		/// </summary>
		public static vShomeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class vShomeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new vShomeHelpKeywordHelperBase.
		/// </summary>
		protected vShomeHelpKeywordHelperBase()
			: base() { }
